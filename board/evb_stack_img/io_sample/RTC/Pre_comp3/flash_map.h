...
example:
    ...
    3) OTA Bank0:                                    328K (0x00802000)
        ...
        e) APP code                    160K (0x0082C000)
        f) APP data1                     0K (0x00854000)
...
#define OTA_TMP_SIZE                    0x00028000  //160K Bytes
...
#define BANK0_APP_DATA1_ADDR            0x00854000
