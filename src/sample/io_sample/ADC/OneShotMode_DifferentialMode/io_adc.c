...
void driver_adc_init(void)
{
    ...
    /** Configure the ADC sampling schedule, a schedule represents an ADC channel data,
      ...
      * If one of the differential channel pairs uses P2_x, x = 0/2/4/6, then the other differential channel must be P2_x+1;
      * If one of the differential channel pairs uses P2_x, x = 1/3/5/7, then the other differential channel must be P2_x-1.
    ...
    case 0x02:
        ...
        break;
    case 0x04:
        ADC_BypassCmd(4, ENABLE);
        ADC_BypassCmd(5, ENABLE);
        break;
    case 0x06:
        ADC_BypassCmd(6, ENABLE);
        ADC_BypassCmd(7, ENABLE);
        break;
    default:
        break;
    }
    ...
    ADC_BypassCmd(4, DISABLE);
    ADC_BypassCmd(5, DISABLE);
    ADC_BypassCmd(6, DISABLE);
    ADC_BypassCmd(7, DISABLE);
